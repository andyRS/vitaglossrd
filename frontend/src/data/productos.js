...
export const productos = [
  ...
  // ── PRODUCTOS DE PRUEBA — Certificación Pagadito ─────────────────────────────
  // IDs 901-904. NO aparecen en ninguna página pública (categoria: '_test').
  // Solo accesibles vía URL directa: /producto/test-cert-1, etc.
  {
    id: 901,
    nombre: "Test Certificación Pagadito #1",
    nombreCorto: "Test Cert #1",
    categoria: "_test",
    articulo: "TEST-PAGADITO-1",
    ...PRECIOS[901],
    pv: 0,
    bv: 0,
    disponible: true,
    stock: "En stock",
    descripcion: "Producto de prueba técnica para certificación Pagadito. Monto: $8.44 USD.",
    descripcionLarga: "Producto de prueba técnica para certificación Pagadito.",
    beneficios: [],
    instrucciones: [],
    detalles: [],
    faqs: [],
  ...
  {
    id: 902,
    nombre: "Test Certificación Pagadito #2",
    nombreCorto: "Test Cert #2",
    categoria: "_test",
    articulo: "TEST-PAGADITO-2",
    ...PRECIOS[902],
    pv: 0,
    bv: 0,
    disponible: true,
    stock: "En stock",
    descripcion: "Producto de prueba técnica para certificación Pagadito. Monto: $23.79 USD.",
    descripcionLarga: "Producto de prueba técnica para certificación Pagadito.",
    beneficios: [],
    instrucciones: [],
    detalles: [],
  ...
  {
    id: 903,
    nombre: "Test Certificación Pagadito #3",
    nombreCorto: "Test Cert #3",
    categoria: "_test",
    articulo: "TEST-PAGADITO-3",
    ...PRECIOS[903],
    pv: 0,
    bv: 0,
    disponible: true,
    stock: "En stock",
    descripcion: "Producto de prueba técnica para certificación Pagadito. Monto: $99.91 USD.",
    descripcionLarga: "Producto de prueba técnica para certificación Pagadito.",
    beneficios: [],
    instrucciones: [],
    detalles: [],
  ...
  {
    id: 904,
    nombre: "Test Certificación Pagadito #4",
    nombreCorto: "Test Cert #4",
    categoria: "_test",
    articulo: "TEST-PAGADITO-4",
    ...PRECIOS[904],
    pv: 0,
    bv: 0,
    disponible: true,
    stock: "En stock",
    descripcion: "Producto de prueba técnica para certificación Pagadito. Monto: $104.12 USD.",
    descripcionLarga: "Producto de prueba técnica para certificación Pagadito.",
    beneficios: [],
    instrucciones: [],
    detalles: [],
