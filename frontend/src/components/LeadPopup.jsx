                ...
                {!enviado ? (
                  <>
                    ...
                    <div className="text-center mb-5">
                      ...
                      <h2 className="text-white font-black text-xl mb-1">¡Antes de irte!</h2>
                      <p className="text-white/60 text-sm">Regístrate y recibe <span className="text-yellow-300 font-black">10% de descuento</span> en tu primer pedido</p>
                      <span className="inline-flex items-center gap-1.5 bg-yellow-400 text-yellow-900 font-black text-xs px-4 py-1.5 rounded-full mt-3">
                        ⚡ Solo para nuevos clientes — Oferta limitada
                      </span>
                    </div>
